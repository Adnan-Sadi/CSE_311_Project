...
<img class="logo" src="../seperation/images/acm.png" alt="Logo">
...
<img id="mainHeadImg" src="" alt="Club HOME" style="width: 90%; height:400px; margin:20px">
<script>
    
$(document).ready( function() {
            $.ajax({
                type: 'POST',
                url: '../seperation/database/clubdescription.php',
                data: 'id=testdata',
                dataType: 'json',
                cache: false,
    ...
    function designMain(mainArray){
        ...
        $('#mainHeadImg').attr('src','../seperation/images/'+ mainArray[0]['ClubImg']);
        ...
        $('#mainHeadImg').addClass('contact-logo');
