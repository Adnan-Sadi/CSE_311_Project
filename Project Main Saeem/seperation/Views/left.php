...
$("#nextRecentEventAd").click();
    ...
    function adChange(EventsTiming,val){
        ...
        function eventAd(){
            $.ajax({
                type: 'POST',
                url: '../seperation/database/clubEvents.php',
        ...
        $("#"+EventsTiming+"c"+eventAdID).append('<img class= eventAdvertisement src="../seperation/images/unnamed.jpg" alt="">');
...
// $("#getAllAventAd").click(()=>{
//             $("#allEvents").load("D:\xampp\htdocs\Project Main Saeem\seperation\Views\events.php");
//         });
</script>
<div class="container">
    <div class="center" >
