...
$(document).ready( function() {
            $.ajax({
                type: 'POST',
                url: '../seperation/database/executive.php',
                data: 'id=testdata',
                dataType: 'json',
                cache: false,
    ...
    function makeDesign(exArray){
        // var str = "../seperation/images/Hossain.jpeg ";
        var strID=0;
                        // console.log(exArray);
                        // console.log(exArray[0]['picture']);
                        // console.log(exArray[0]['total']);
        for(var i=0;i<exArray.length;i++){
        $('#ex').append(' <div id = ex'+ strID +' class="card-body" style="width: 20000px;"></div>');
        $('#ex'+strID).append(' <img src='+'../seperation/images/'+ exArray[i]["picture"]+ ' width="100% " alt="Pro pic ">');    
